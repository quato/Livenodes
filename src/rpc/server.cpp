...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop LivenodesCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "LivenodesCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LivenodesCoin features */
        {"livenodes", "listmasternodes", &listmasternodes, true, true, false},
        {"livenodes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"livenodes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"livenodes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"livenodes", "masternodedebug", &masternodedebug, true, true, false},
        {"livenodes", "startmasternode", &startmasternode, true, true, false},
        {"livenodes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"livenodes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"livenodes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"livenodes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"livenodes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"livenodes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"livenodes", "mnsync", &mnsync, true, true, false},
        {"livenodes", "spork", &spork, true, true, false},
        {"livenodes", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use livenodesd, or the -server option to livenodes-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               "It is recommended you use the following random password:\n"
                                               "rpcuser=livenodesrpc\n"
                                               "rpcpassword=%s\n"
                                               "(you do not need to remember this password)\n"
                                               "The username and password MUST NOT be the same.\n"
                                               "If the file does not exist, create it with owner-readable-only file permissions.\n"
                                               "It is also recommended to set alertnotify so you are notified of problems;\n"
                                               "for example: alertnotify=echo %%s | mail -s \"LivenodesCoin Alert\" admin@foo.com\n"),
...
{
    return "> livenodes-cli " + methodname + " " + args + "\n";
}
