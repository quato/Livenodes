...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("LivenodesCoin Core");
    ...
    QString copyrightTextLivenodesCoin = QChar(0xA9) + QString(" 2018-2019 ").arg(COPYRIGHT_YEAR) + QString(tr("The Livenodes developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextLivenodesCoin);
